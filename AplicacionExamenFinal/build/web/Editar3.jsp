...
<html>
    <head>
        ...
        <title>EditarProfesion</title>
    </head>
    <body>
        <h2 align="center">Editar Profesion</h2>
        <%
            String cod = request.getParameter("cod");
                ...
                rs= sta.executeQuery("select * from profesion where IdProfesion='"+cod+"'");
        ...
        <form action="">
            <table border="1" whidth="250" align="center">
                ...
                <tr>
                    ...
                    sta.executeUpdate("update profesion set NombreProfesion='"+pro+"' where IdProfesion='"+codu +"'");
